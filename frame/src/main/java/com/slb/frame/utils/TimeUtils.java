...
public class TimeUtils {
    ...
    public static final SimpleDateFormat DEFAULT_ymdhm = new SimpleDateFormat("yyyy-MM-dd HH:mm", Locale.getDefault());

    public static final SimpleDateFormat DEFAULT_CHAR = new SimpleDateFormat("yyyy年MM月dd日 HH:mm:ss", Locale.getDefault());
    public static final SimpleDateFormat DEFAULT_ymd = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault());
    public static final SimpleDateFormat DEFAULT_hm = new SimpleDateFormat("HH:mm", Locale.getDefault());
