package com.slb.frame.utils.security;
...
public class Security {
	...
	public static byte[] decryptOTAPackage(byte[] key, byte[] data)
		 ...
		 * @return
		 */
	public static String getMD5Value(long time) {
		try{
			String value = ""+time;
			value = SecurityUtils.encryMD5(value).substring(11,17).toUpperCase();
			return value;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static String getMD5Value(String time) {
		try{
			String value = "";
			value = SecurityUtils.encryMD5(time).substring(11,17).toUpperCase();
			return value;
		}
		catch (Exception e) {
			e.printStackTrace();
