...
public class OrderFragment extends BaseMvpFragment<WebViewFragmentContract.IView, WebViewFragmentContract.IPresenter>
...
//              return shouldOverrideUrlByMJ(view, url);
        ...
        mWebView.loadUrl(MyConstants.h5Url + MyConstants.url_order + Base.getUserEntity().getToken());
        return rootView;
    }
