package danfei.shulaibao.widget.recyclerviewfastscroll;
...
import danfei.shulaibao.widget.recyclerviewfastscroll.FabScrollListener.HideScrollListener;
import danfei.shulaibao.widget.recyclerviewfastscroll.viewprovider.DefaultScrollerViewProvider;
import danfei.shulaibao.widget.recyclerviewfastscroll.viewprovider.ScrollerViewProvider;
...
public class FastScroller extends LinearLayout {
    ...
    public void setHandleViewScrollListener(final HideScrollListener listener){
        handle.setOnScrollChangeListener(new OnScrollChangeListener() {
            @Override
            public void onScrollChange(View v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                ...
                if (visible && scrollY > 0 || (!visible && scrollY < 0)) {
                    distance += scrollY;
                }
            }
        });
